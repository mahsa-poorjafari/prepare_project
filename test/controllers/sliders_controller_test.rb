...
class SlidersControllerTest < ActionController::TestCase
  ...
  test "should create slider" do
    assert_difference('Slider.count') do
      post :create, slider: { description_en: @slider.description_en, description_fa: @slider.description_fa }
    end
  ...
  test "should update slider" do
    patch :update, id: @slider, slider: { description_en: @slider.description_en, description_fa: @slider.description_fa }
    assert_redirected_to slider_path(assigns(:slider))
  end
